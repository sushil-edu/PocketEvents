package kestone.com.pocketevents.MODEL.Manager;

import java.util.ArrayList;
import java.util.List;

import kestone.com.pocketevents.MODEL.Design.RESPONSE.DesignResponse;
import kestone.com.pocketevents.MODEL.Design.RESPONSE.DesignResult;
...
public class MySingleton {
    ...
    List<kestone.com.pocketevents.MODEL.Venue.RESPONSE.Payload> compare = new ArrayList<>();
    ...
    public List<kestone.com.pocketevents.MODEL.Venue.RESPONSE.Payload> getCompare() {
        return compare;
    }

    public void setCompare(List<kestone.com.pocketevents.MODEL.Venue.RESPONSE.Payload> compare) {
