...
//    }
    ...
    //Payloads
    public void storePayload1(List<kestone.com.pocketevents.MODEL.Filters.RESPONSE.Payload> payload3) {
        preferences = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    public List<kestone.com.pocketevents.MODEL.Filters.RESPONSE.Payload> loadPayload1() {
        preferences = PreferenceManager.getDefaultSharedPreferences(context);
        Gson gson = new Gson();
        String json = preferences.getString("payload1", null);
        Type type = new TypeToken<List<kestone.com.pocketevents.MODEL.Filters.RESPONSE.Payload>>() {
        }.getType();
        return gson.fromJson(json, type);
    }
    public void storePayload1Original(List<kestone.com.pocketevents.MODEL.Filters.RESPONSE.Payload> payload3) {
        preferences = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    public List<kestone.com.pocketevents.MODEL.Filters.RESPONSE.Payload> loadPayload1Original() {
        preferences = PreferenceManager.getDefaultSharedPreferences(context);
        Gson gson = new Gson();
    ...
    public void storePayload2(List<kestone.com.pocketevents.MODEL.Filters.RESPONSE.Payload> payload3) {
        preferences = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    public List<kestone.com.pocketevents.MODEL.Filters.RESPONSE.Payload> loadPayload2() {
        preferences = PreferenceManager.getDefaultSharedPreferences(context);
        Gson gson = new Gson();
    ...
    public void storePayload3(List<kestone.com.pocketevents.MODEL.Filters.RESPONSE.Payload> payload3) {
        preferences = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    public List<kestone.com.pocketevents.MODEL.Filters.RESPONSE.Payload> loadPayload3() {
        preferences = PreferenceManager.getDefaultSharedPreferences(context);
        Gson gson = new Gson();
