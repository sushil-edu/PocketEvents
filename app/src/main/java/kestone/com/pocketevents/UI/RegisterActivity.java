...
import kestone.com.pocketevents.MODEL.RefferalValidation.REQUEST.RefferalValidationRequest;
import kestone.com.pocketevents.MODEL.RefferalValidation.RESPONSE.RefferalValidationResponse;
...
import kestone.com.pocketevents.MODEL.RewardsReferrals.REQUEST.ReferralsRewardRequest;
...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    TextView login, otp;
    AppCompatEditText fname, email,  pass, cpass, register_et_refferal_code, register_et_address, mobile;
...
//        lname = (AppCompatEditText)findViewById(R.id.register_et_lname);
        ...
        chkTermAndCondition= (CheckBox) findViewById( R.id.chkTermAndConditions );
        termsandcondition = (TextView) findViewById( R.id.tvTermAndCondition );
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.tvTermAndCondition:
                Intent intent = new Intent( RegisterActivity.this, TermsAndConditions.class);
            ...
            case R.id.register_btn_otp:
                ...
                if (pass.getText().toString().equals(cpass.getText().toString()) && GeneralUtils.isEmailValid(email.getText().toString()) && chkTermAndCondition.isChecked()) {
                    ...
                    showPopUp("Terms and Conditions", "Please check terms and condition", "OK");
                }
                else {
