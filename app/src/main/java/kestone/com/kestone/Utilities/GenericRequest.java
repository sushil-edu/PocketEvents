...
public class GenericRequest<T> extends JsonRequest<T> {
     ...
     * @param errorListener: Error handler of the request
     */
    public GenericRequest(int method, String url, Class<T> classtype, Object toBeSent, Response.Listener<T> listener, Response.ErrorListener errorListener) {

        this(method, classtype, url, new Gson().toJson(toBeSent), listener,
                errorListener, new HashMap<String, String>());

        GeneralUtils.log("VOLLEY REQUEST : " + url,new Gson().toJson(toBeSent) + " ");
    }
     ...
     * @param errorListener: Error handler of the request
     */
    public GenericRequest(int method, String url, Class<T> classtype, String requestBody, Response.Listener<T> listener, Response.ErrorListener errorListener) {
    ...
    protected Response<T> parseNetworkResponse(NetworkResponse response) {
        ...
        try {
            ...
            GeneralUtils.log("VOLLEY RESPONSE", jsonLog + " ");
        } catch (Exception e) {
            GeneralUtils.log("VOLLEY RESPONSE", jsonLog + " ");
        }
